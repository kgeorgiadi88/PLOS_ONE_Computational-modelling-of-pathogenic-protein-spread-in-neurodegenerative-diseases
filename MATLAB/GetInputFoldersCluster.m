function [LoadDirectories, SaveDirectories, VariablesSize, VariablesNames] = GetInputFoldersCluster
BaseLoadPath = '/SAN/medic/nexopathy/';
BaseSavePath = '/SAN/medic/nexopathy/Results/1C/';

NumVariables=0;

NumVariables=NumVariables+1;
VariablesSize(NumVariables)=1;
