...
#define DCai _p[9]
#define iCa _p[10]
#define drive_channel _p[11]
#define drive_pump _p[12]
#define v _p[13]
#define _g _p[14]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 15, 4);
 	...
 	ivoc_help("help ?1 Cad /home/konstantinos/Desktop/NEURON/ncdemo/x86_64/cp2.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   ...
   DCai = drive_channel + drive_pump + ( Cainf - Cai ) / taur + ( Cainf2 - Cai ) / taur2 ;
   }
 return _reset;
}
 ...
 static int state (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
   ...
   drive_pump = - kt * Cai / ( Cai + kd ) ;
    Cai = Cai + (1. - exp(dt*(( ( ( - 1.0 ) ) ) / taur + ( ( ( - 1.0 ) ) ) / taur2)))*(- ( drive_channel + drive_pump + ( ( Cainf ) ) / taur + ( ( Cainf2 ) ) / taur2 ) / ( ( ( ( - 1.0) ) ) / taur + ( ( ( - 1.0) ) ) / taur2 ) - Cai) ;
   }
  return 0;
}
