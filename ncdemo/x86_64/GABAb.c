...
#define Exp1 Exp1_GABAb
 extern double Exp1( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define Alpha Alpha_GABAb
 double Alpha = 0.016;
#define Beta Beta_GABAb
 double Beta = 0.0047;
#define Cdur Cdur_GABAb
 double Cdur = 85;
#define Rtau Rtau_GABAb
 double Rtau = 0;
#define Rinf Rinf_GABAb
 double Rinf = 0;
 ...
 "Alpha_GABAb", &Alpha_GABAb,
 "Beta_GABAb", &Beta_GABAb,
 "Rinf_GABAb", &Rinf_GABAb,
 "Rtau_GABAb", &Rtau_GABAb,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GABAb /home/konstantinos/Desktop/NEURON/ncdemo/x86_64/GABAb.mod\n");
