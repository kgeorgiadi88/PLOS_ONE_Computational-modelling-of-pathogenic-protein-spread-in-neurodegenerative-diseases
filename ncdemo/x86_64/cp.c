...
#define drive_pump _p[10]
#define drive_pump2 _p[11]
#define cai _p[12]
#define Dcai _p[13]
#define ica _p[14]
#define v _p[15]
...
#define kd2 kd2_cad
 ...
 "kt2_cad", "mM/ms",
 "kd_cad", "mM",
 "drive_channel_cad", "mM/ms",
 "drive_pump_cad", "mM/ms",
 "drive_pump2_cad", "mM/ms",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 17, 4);
 	...
 	ivoc_help("help ?1 cad /home/konstantinos/Desktop/NEURON/ncdemo/x86_64/cp.mod\n");
